...
using iq.mnl.beertap.Documentation.Installers;
using iq.mnl.beertap.WebApi.Handlers;
using iq.mnl.beertap.WebApi.Hypermedia;
using iq.mnl.beertap.WebApi.Infrastructure.Installers;
using iq.mnl.beertap.Model;
using IQ.Platform.Framework.WebApi.Infrastructure;

namespace iq.mnl.beertap.WebApi.Infrastructure
{
